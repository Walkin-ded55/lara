...
navCross.addEventListener("click", function(){
  ...
  <main class="main">
    <div class="main__inner">
        <a href="{{route("catalog")}}" class="link__image"><img src="{{asset('assets/img/0.png')}}" alt="" width="550px"height="550px"></a>
        <a href="{{route("catalog")}}" class="link__image"><img src="{{asset('assets/img/0.png')}}" alt="" width="550px"height="550px"></a>
    </div>
    <div class="shope">
      <a href="{{route("aboutus")}}" class="link__image1"><img src="{{asset('assets/img/shope.png')}}" alt="" width="900px"height="900px"></a>
  </div>
  </main>
  <footer class="footer">
